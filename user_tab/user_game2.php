...
<body class="flex flex-col items-center justify-center min-h-screen p-4">
    ...
    <script>
        ...
        function checkAnswer(selected, btn) {
            ...
            const isCorrect = selected === q.sound;
            ...
            fetch('update_beginning_sound.php', {
                ...
                body: JSON.stringify({
                    ...
                    correct_letter: q.sound
                })
            })
                .then(res => res.json())
                .then(data => {
                    if (!data.success) console.warn("Failed to save progress");
                });
        ...
        function showCompletion() {
            ...
            fetch('update_beginning_sound.php', {
                ...
                body: JSON.stringify({
                    ...
                    completed_questions: qIds
                })
            }).then(res => res.json())
                .then(data => {
                    if (!data.success) console.warn("Failed to save final progress");
                });
            ...
            // Add buttons dynamically: Play Again or Go Home
            // const btnContainer = document.createElement('div');
            // btnContainer.className = 'flex justify-center gap-4 mt-6';
            ...
            // homeBtn.onclick = () => window.location.href = "../Users/dashboard.html";

            btnContainer.appendChild(playAgainBtn);
            btnContainer.appendChild(homeBtn);
            completionScreen.appendChild(btnContainer);
        }
